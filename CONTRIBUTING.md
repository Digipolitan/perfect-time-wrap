# Contributing to perfect-time-wrap-swift
...
* **Did the problem start happening recently** (e.g. after updating to a new version of perfect-time-wrap-swift) or was this always a problem?
* If the problem started happening recently, **can you reproduce the problem in an older version of perfect-time-wrap-swift ?** What's the most recent version in which the problem doesn't happen? You can download older versions of perfect-time-wrap-swift from [the releases page](https://github.com/digipolitan/perfect-time-wrap-swift/releases).
* **Can you reliably reproduce the issue?** If not, provide details about how often the problem happens and under which conditions it normally happens.

Include details about your configuration and environment:

* **Which version of perfect-time-wrap-swift are you using?
...
#### Template For Submitting Bug Reports
    ...
    **perfect-time-wrap-swift version:** [Enter perfect-time-wrap-swift version here]
    ...
    * Problem started happening recently, didn't happen in an older version of perfect-time-wrap-swift: [Yes/No]
